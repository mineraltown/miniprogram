...
Component({
    ...
    created() {
        ...
        // 读档
        if (!wx.getStorageSync("trio")) {
            console.log("初始化")
            wx.setStorageSync("trio", {
                year: 1,
                month: 0,
                day: 1,
                birthday_month: 0,
        ...
        wx.request({
            url: app.globalData.url + "todo/trio/resident",
            header: {
        ...
        wx.request({
            url: app.globalData.url + "todo/trio/festival",
            header: {
                'content-type': 'application/json'
            },
            success(res) {
